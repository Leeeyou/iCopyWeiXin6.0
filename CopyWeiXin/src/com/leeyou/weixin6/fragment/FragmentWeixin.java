package com.leeyou.weixin6.fragment;
...
import com.leeyou.weixin6.R;
import com.leeyou.weixin6.bean.WeiXin;
import com.leeyou.weixin6.manager.UniversalAdapter;
import com.leeyou.weixin6.manager.ViewHolder;
...
public class FragmentWeixin extends SherlockListFragment {
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.menu_item_read:
			com.leeyou.weixin6.utils.T.showShort(getActivity(), "标为未读");
			return true;
		case R.id.menu_item_top:
			com.leeyou.weixin6.utils.T.showShort(getActivity(), "置顶");
			return true;
		case R.id.menu_item_delete:
			com.leeyou.weixin6.utils.T.showShort(getActivity(), "删除该聊天");
			return true;
		}
